...
```ts
function createRemoteCompute(
  options: RemoteComputeOptionsInterface
): RemoteCompute;
```

Defined in:
[index.ts:143](https://github.com/phun-ky/hybrid-compute/blob/06125d8e4713eac0ec73aa47f10b979c19a091dd/packages/remote/src/index.ts#L143)
